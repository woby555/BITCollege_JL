...
namespace Utility
{
    ...
    public static class BusinessRules
    {
        ...
        /// <summary>
        /// ParseString: Returns the typeName of a given string.
        /// </summary>
        /// <param name="typeName">The type name.</param>
        /// <param name="suffix">The suffix of type name which will be removed.</param>
        /// <returns>A string consisting of just the type name.</returns>
        /*public static string ParseString(string typeName, string suffix)
        {
            if (typeName.EndsWith(suffix))
            {
                int index = typeName.LastIndexOf(suffix);
                if (index >= 0)
                {
        ...
        public static string ParseString(string typeName, string suffix)
        {
            ...
            {
                int index = typeName.IndexOf(suffix);
                if (index >= 0)
                {
                    return typeName.Substring(0, index);
                }
